      ...
      <div className="container mx-auto max-w-6xl">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="text-center md:text-left">
            ...
            {/* Developer names branding */}
            <div className="mt-4 text-zinc-400 text-sm">
              <span className="font-semibold text-white">Développeurs :</span>
              <span className="ml-2">Djochrist Kuma-Kuma</span>,
              <span className="ml-2">Michael Losinu</span>,
              <span className="ml-2">Carrel Kime</span>
            </div>
          </div>
        ...
        >
          ...
          >
            Departement Informatique - Faculté des Sciences et Technologies - Université de Lubumbashi/RDC
          </motion.p>
        </motion.div>
      </div>
    </footer>
